    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RadioGroup.OnCheckedChangeListener listener3 = new RadioGroup.OnCheckedChangeListener()
        {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId)
            {
                ...
                switch(checkedId)
                {
                    case R.id.radioCat: drawableId = R.drawable.animal_cat_large;
                    break;
                    case R.id.radioDog: drawableId = R.drawable.animal_dog_large;
                    break;
                    case R.id.radioOwl: drawableId = R.drawable.animal_owl_large;
                    break;
                }
        ...
        button.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                {
                    case R.id.radioRed: s += "red ";
                    break;
                    case R.id.radioYellow: s += "yellow ";
                    break;
                    case R.id.radioBlue: s += "blue ";
                    break;
                }
                switch (radioGroup2.getCheckedRadioButtonId())
                {
                    case R.id.radioCat: s += "cat";
                        break;
                    case R.id.radioDog: s += "dog";
                        break;
                    case R.id.radioOwl: s += "owl";
                        break;
                }
                Toast.makeText(CheckboxesActivity.this, s, Toast.LENGTH_SHORT).show();
            }
