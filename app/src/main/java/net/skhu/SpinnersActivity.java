...
public class SpinnersActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            {
                Spinner spinnerAdd = (Spinner)findViewById(R.id.spinner_addressType);
                int indexAdd = spinnerAdd.getSelectedItemPosition();
                String textSelected = spinnerAdd.getSelectedItem().toString();
                String add = String.format("변경된 주소:%s(%d)", textSelected, indexAdd);
                Toast.makeText(SpinnersActivity.this, add, Toast.LENGTH_SHORT).show();
            }
